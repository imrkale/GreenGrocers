...
import 'package:greengrocers/userside/CheckoutPage/foods.dart';
import 'package:greengrocers/userside/CheckoutPage/cart_item.dart';
...
//                print(foods.length);
                return CartItem(
                  img: user.userModel.cart[index].image,
                  isFav: false,
                  name: user.userModel.cart[index].name,
                  rating: 5.0,
                  raters: 23,
                  store: user.userModel.cart[index].restaurant,
                  price: user.userModel.cart[index].price,
                  qty: user.userModel.cart[index].quantity,
                );
              },
            ):Card(
              elevation: 5.0,
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          r"$ "+"${user.userModel.totalCartPrice+50}",
                          style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.w900,
                            color: Theme.of(context).accentColor,
                  ...
                  Container(
                    ...
                    child: FlatButton(
                      ...
                      onPressed: (){
                        Navigator.push(
                            context, MaterialPageRoute(builder: (BuildContext context) => HomePagePayment()));
                      },
                    ),
                  ),
