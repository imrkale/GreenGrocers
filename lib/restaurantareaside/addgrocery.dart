...
import 'package:greengrocers/adminside/db/category.dart';
      ...
      if (_image1 != null) {
        if (selectedSizes.isNotEmpty) {
          ...
          final String picture1 =
              "groceryimages/${areaname}/${_currentBrand}/images/${DateTime.now().millisecondsSinceEpoch.toString()}.jpg";
          ...
          await _firestore
              ...
              .then((result) {
                for (DocumentSnapshot product in result.docs) {
                  if (_currentBrand == product.get('name')) {
